...
class ClientControlConnection:
    def __init__(
        ...
        self.logger = logging.getLogger("client.control")
        self.config = config
        ...
        self.client_pub_fp = pubkey_fingerprint(self.private_key.public_key())
    ...
    async def connect_and_handshake(self) -> None:
        reader, writer = await asyncio.open_connection(
            ...
            int(self.config["relay_port_client"]),
        )
        ...
        await conn.send_message(
            ...
            pubkey_fingerprint=self.client_pub_fp,
    ...
    async def message_loop(self) -> None:
        ...
        self._heartbeat_task = asyncio.create_task(self._heartbeat_loop(), name="client-control-heartbeat")
        while True:
